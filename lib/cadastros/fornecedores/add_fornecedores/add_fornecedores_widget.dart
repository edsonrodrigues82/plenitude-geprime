...
import 'add_fornecedores_model.dart';
export 'add_fornecedores_model.dart';

class AddFornecedoresWidget extends StatefulWidget {
  const AddFornecedoresWidget({super.key});

  @override
  State<AddFornecedoresWidget> createState() => _AddFornecedoresWidgetState();
}

class _AddFornecedoresWidgetState extends State<AddFornecedoresWidget> {
  late AddFornecedoresModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddFornecedoresModel());

    _model.switchValue = _model.ativoSN!;
    _model.fornecedorTextController ??= TextEditingController();
    _model.fornecedorFocusNode ??= FocusNode();
    ...
    _model.cnpjcpfTextController ??= TextEditingController();
    _model.cnpjcpfFocusNode ??= FocusNode();

    _model.iergTextController ??= TextEditingController();
    _model.iergFocusNode ??= FocusNode();
                                                ...
                                                child: ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          8.0),
                                                  child: Image.network(
                                                    'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/menu-web-6ue2cn/assets/1exwksmae5jn/CabecaApp.png',
                                                    width: 181.0,
                                                    height: 200.0,
                                                    fit: BoxFit.cover,
                                                  ),
                                                          ...
                                                          child: TextFormField(
                                                            ...
                                                            keyboardType:
                                                                TextInputType
                                                                    .emailAddress,
                                                            validator: _model
                                                                .fornecedorTextControllerValidator
                                                                .asValidator(
                                                                    context),
                                                          ),
                                                        ),
                                                            ...
                                                            child:
                                                              ...
                                                              keyboardType:
                                                                  TextInputType
                                                                      .emailAddress,
                                                              validator: _model
                                                                  .cnpjcpfTextControllerValidator
                                                                  .asValidator(
                                                                      context),
                                                            ),
                                                          ),
                                                        ...
                                                        InkWell(
                                                          ...
                                                          onTap: () async {
                                                            ...
                                                            if ((_model
                                                                ...
                                                                true)) {
                                                              setState(() {
                                                                _model.fornecedorTextController
                                                                        ?.text =
                                                                    valueOrDefault<
                                                                        String>(
                                                                  BuscaCNPJCall
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        highlightColor: Colors.transparent,
                                        onTap: () async {
                                          await FornecedoresTable().insert({
                                            'NOME': _model
                                                .fornecedorTextController.text,
                                            'FANTASIA': _model
                                                .fantasiaTextController.text,
                                            'CONTATO': _model
                                                .contatoTextController.text,
                                            'ENDERECO':
                                                _model.endTextController.text,
                                            'NUMERO':
                                            ...
                                            'CELULAR':
                                                _model.foneTextController.text,
                                            'IE':
                                                _model.iergTextController.text,
                                            'CPF': _model
                                                .cnpjcpfTextController.text,
                                            'RG':
                                                _model.iergTextController.text,
                                            'DATCAD': supaSerialize<DateTime>(
                                                getCurrentTimestamp),
                                            'ATIVO': true,
                                            'empresa_id': 1,
                                          ...
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                ...
                                                content: Text(
                                                    'Fornecedor ${_model.fantasiaTextController.text} cadastrado com sucesso.'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
