...
class _EmpresaWidgetState extends State<EmpresaWidget>
  ...
  void initState() {
    ...
    _model.inscricaoTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.company?.ie,
      '-',
    ));
    _model.inscricaoFocusNode ??= FocusNode();

    _model.enderecoTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.company?.endereco,
      '-',
    ));
    ...
    _model.celTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.company?.whatsapp,
      '-',
    ));
    _model.celFocusNode ??= FocusNode();
                                                      ...
                                                      child: TextFormField(
                                                        ...
                                                        keyboardType:
                                                            TextInputType
                                                                .emailAddress,
                                                        validator: _model
                                                            .inscricaoTextControllerValidator
                                                            .asValidator(
                                                                context),
                                                      ),
                                                    ),
                                                      ...
                                                      image: DecorationImage(
                                                        ...
                                                        image: Image.network(
                                                          valueOrDefault<
                                                            ...
                                                            widget.company
                                                                ?.logomarca,
                                                            'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/super-agendamento-ou3q3c/assets/vmyg9qj7go46/ERS_Logo.jpg',
                                                          ),
                                                        ).image,
                                                      ),
                                                      borderRadius:
                                      ...
                                      onTap: () async {
                                            ...
                                            await showDialog<bool>(
                                                  ...
                                                  builder:
                                                    ...
                                                    return AlertDialog(
                                                      ...
                                                      content: Text(
                                                          'Vccê confirma a alteração cadastral na empresa ${_model.fantasiaTextController.text}?'),
                                                      actions: [
                                                        TextButton(
                                                          onPressed: () =>
                                                              Navigator.pop(
                                        ...
                                        if (confirmDialogResponse) {
                                          await EmpresaTable().update(
                                            data: {
                                              'razao': _model
                                                  .razaoTextController.text,
                                              'fantasia': _model
                                                  .fantasiaTextController.text,
                                              'endereco': _model
                                                  .enderecoTextController.text,
                                              'cidade': _model.cidadeValue,
                                              'uf': _model.ufValue,
                                              'telefone': _model
                                                  .foneTextController.text,
                                              'celular':
                                                  _model.celTextController.text,
                                              'whatsapp':
                                                  _model.celTextController.text,
                                              'bloquear': false,
                                              'logomarca':
                                                  'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/super-agendamento-ou3q3c/assets/vmyg9qj7go46/ERS_Logo.jpg',
                                              'reduzidoNoMobile': false,
                                              'cnpj': '54139278000173',
                                              'ie': '19.0002636',
                                              'bairro': _model
                                          ...
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                ...
                                                content: Text(
                                                    'Empresa ${_model.fantasiaTextController.text} Alterada com sucesso.'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
