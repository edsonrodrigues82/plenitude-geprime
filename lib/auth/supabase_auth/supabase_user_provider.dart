...
class PlenitudeGEPrimeSupabaseUser extends BaseAuthUser {
  PlenitudeGEPrimeSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> plenitudeGEPrimeSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = PlenitudeGEPrimeSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
