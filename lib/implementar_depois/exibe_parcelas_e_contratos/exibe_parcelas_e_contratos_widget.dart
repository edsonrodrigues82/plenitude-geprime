...
import '/geral/recebimento_pagamento/recebimento_pagamento_widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'exibe_parcelas_e_contratos_model.dart';
export 'exibe_parcelas_e_contratos_model.dart';

class ExibeParcelasEContratosWidget extends StatefulWidget {
  const ExibeParcelasEContratosWidget({
    super.key,
    required this.alteraLayout,
    bool? verParcelas,
    required this.contratos,
  }) : verParcelas = verParcelas ?? false;

  final int? alteraLayout;
  final bool verParcelas;
  final ContratosStruct? contratos;

  @override
  State<ExibeParcelasEContratosWidget> createState() =>
      _ExibeParcelasEContratosWidgetState();
}

class _ExibeParcelasEContratosWidgetState
    extends State<ExibeParcelasEContratosWidget> {
  late ExibeParcelasEContratosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExibeParcelasEContratosModel());
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Builder(
                                          builder: (context) {
                                            final parcelas =
                                                FFAppState().contatos.toList();
                                            return Column(
                                              mainAxisSize: MainAxisSize.max,
                                              children:
                                                  List.generate(parcelas.length,
                                                      (parcelasIndex) {
                                                final parcelasItem =
                                                    parcelas[parcelasIndex];
                                                return Row(
                                                  mainAxisSize:
                                                      MainAxisSize.max,
                                                  mainAxisAlignment:
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      wrapWithModel(
                                        model: _model.btGeralSemTextoModel7,
                                        updateCallback: () => setState(() {}),
                                        child: const BtGeralSemTextoWidget(
                                          imagem:
                                              'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/plenitude-system-g-e-prime-vrkyat/assets/mczdnrf821nh/Excluir.png',
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      wrapWithModel(
                                        model: _model.btGeralSemTextoModel8,
                                        updateCallback: () => setState(() {}),
                                        child: const BtGeralSemTextoWidget(
                                          imagem:
                                      ...
                                      wrapWithModel(
                                        model: _model.btGeralSemTextoModel9,
                                        updateCallback: () => setState(() {}),
                                        child: const BtGeralSemTextoWidget(
                                          imagem:
                                                      ...
                                                      const AlignmentDirectional(
                                                          ...
                                                          .resolve(
                                                              Directionality.of(
                                                                  context)),
                                                  child:
                                                      const RecebimentoPagamentoWidget(),
                                                );
                                              },
                                            ).then((value) => setState(() {}));
                                          },
                                  ...
                                  children: [
                                    ...
                                    Builder(
                                      builder: (context) => InkWell(
                                        ...
                                        child: wrapWithModel(
                                          model: _model.btGeralSemTextoModel10,
                                          updateCallback: () => setState(() {}),
                                          child: const BtGeralSemTextoWidget(
                                            imagem:
                                                'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/menu-web-6ue2cn/assets/10txt8b66mz5/pagar2.png',
