...
import 'exibe_parcelas_e_contratos_widget.dart'
    show ExibeParcelasEContratosWidget;
import 'package:flutter/material.dart';

class ExibeParcelasEContratosModel
    extends FlutterFlowModel<ExibeParcelasEContratosWidget> {
  ...
  // Model for btGeralSemTexto component.
  late BtGeralSemTextoModel btGeralSemTextoModel7;
  // Model for btGeralSemTexto component.
  late BtGeralSemTextoModel btGeralSemTextoModel8;
  // Model for btGeralSemTexto component.
  late BtGeralSemTextoModel btGeralSemTextoModel9;
  // Model for btGeralSemTexto component.
  late BtGeralSemTextoModel btGeralSemTextoModel10;
  ...
  void initState(BuildContext context) {
    ...
    btGeralSemTextoModel7 = createModel(context, () => BtGeralSemTextoModel());
    btGeralSemTextoModel8 = createModel(context, () => BtGeralSemTextoModel());
    btGeralSemTextoModel9 = createModel(context, () => BtGeralSemTextoModel());
    btGeralSemTextoModel10 = createModel(context, () => BtGeralSemTextoModel());
  }
  ...
  void dispose() {
    ...
    btGeralSemTextoModel7.dispose();
    btGeralSemTextoModel8.dispose();
    btGeralSemTextoModel9.dispose();
    btGeralSemTextoModel10.dispose();
  }
}
