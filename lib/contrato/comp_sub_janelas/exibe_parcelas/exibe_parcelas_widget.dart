...
import 'exibe_parcelas_model.dart';
export 'exibe_parcelas_model.dart';

class ExibeParcelasWidget extends StatefulWidget {
  const ExibeParcelasWidget({super.key});

  @override
  State<ExibeParcelasWidget> createState() => _ExibeParcelasWidgetState();
}

class _ExibeParcelasWidgetState extends State<ExibeParcelasWidget> {
  late ExibeParcelasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExibeParcelasModel());
                          ...
                          await showDialog(
                            ...
                            builder: (dialogContext) {
                              return Dialog(
                                ...
                                alignment: const AlignmentDirectional(0.0, 0.0)
                                    .resolve(Directionality.of(context)),
                                child: const RecebimentoPagamentoWidget(),
                              );
                            },
                          ).then((value) => setState(() {}));
                        },
