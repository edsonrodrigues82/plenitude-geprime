...
import 'exibe_parcelas_e_contrato_model.dart';
export 'exibe_parcelas_e_contrato_model.dart';

class ExibeParcelasEContratoWidget extends StatefulWidget {
  const ExibeParcelasEContratoWidget({
    super.key,
  ...
  @override
  State<ExibeParcelasEContratoWidget> createState() =>
      _ExibeParcelasEContratoWidgetState();
}

class _ExibeParcelasEContratoWidgetState
    extends State<ExibeParcelasEContratoWidget> {
  late ExibeParcelasEContratoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExibeParcelasEContratoModel());
